...
fn demo_routes() -> Vec<Route> {
    vec![
        r("id-api", "id.w33d.xyz", "/api", "http://whoami:80", "bearer", false),
        r("id-root", "id.w33d.xyz", "/", "https://keystone:8443", "public", true),
        r("status-root", "status.w33d.xyz", "/", "http://beacon:8400", "public", false),
        r("vitals-root", "vitals.w33d.xyz", "/", "http://vitals:8300", "sso", false),
        r("audit-root", "audit.w33d.xyz", "/", "http://watchtower:8500", "sso", false),
        r("portal-root", "w33d.xyz", "/", "http://portal:8600", "sso", false),
        r("blog-root", "blog.w33d.xyz", "/", "http://inkwell:8700", "sso", false),
        r("forum-root", "forum.w33d.xyz", "/", "http://agora:8710", "sso", false),
        r("wiki-root", "wiki.w33d.xyz", "/", "http://lattice:8720", "sso", false),
        r("paste-root", "paste.w33d.xyz", "/", "http://pastefire:8730", "sso", false),
        r("drive-share", "drive.w33d.xyz", "/s/", "http://aperture:8900", "public", false),
        r("drive-root", "drive.w33d.xyz", "/", "http://aperture:8900", "sso", false),
        r("search-root", "search.w33d.xyz", "/", "http://cortex:8950", "sso", false),
        r("cal-root", "cal.w33d.xyz", "/", "http://almanac:8960", "sso", false),
        r("rss-root", "rss.w33d.xyz", "/", "http://current:8970", "sso", false),
        r("clip-root", "clip.w33d.xyz", "/", "http://magpie:8980", "sso", false),
        r("vault-root", "vault.w33d.xyz", "/", "http://sanctum:8990", "sso", false),
        r("intel-root", "intel.w33d.xyz", "/", "http://oracle:9010", "sso", false),
        r("canary-trip", "canary.w33d.xyz", "/t/", "http://mirage:9020", "public", false),
        r("canary-root", "canary.w33d.xyz", "/", "http://mirage:9020", "sso", false),
        r("registry-v2", "registry.w33d.xyz", "/v2/", "http://cellar:9040", "public", false),
        r("registry-root", "registry.w33d.xyz", "/", "http://cellar:9040", "sso", false),
        r("git-protocol", "git.w33d.xyz", "/git/", "http://loom:9030", "public", false),
        r("git-root", "git.w33d.xyz", "/", "http://loom:9030", "sso", false),
        r("atlas-root", "atlas.w33d.xyz", "/", "http://atlas:9250", "sso", false),
    ]
}
